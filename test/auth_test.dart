...
void main() {
  group('Mock Authentication', () {
    ...
    test(
      'Should be able to be initializ in less than 2 seconds',
      () async {
        await provider.initialize();
        expect(provider.isInitialized, true);
      },
    ...
    test('Create user should delegate to logIn function', () async {
      ...
      final wrongPasswordUser =
          provider.createUser(email: 'email@foo.com', password: 'foobar');
      expect(wrongPasswordUser,
          throwsA(const TypeMatcher<WrongPasswordAuthException>()));

      final user =
          await provider.createUser(email: 'emaioo.com', password: 'fbar');
